	...
	<div class="block">
		<div class="block-header">
			...
			<div class="pull-right">
				<a href="<?=admin_url($this->mod.'/add-new');?>" class="button btn-sm btn-primary mr-2"><i class="icon-add mr-2"></i><?=lang_line('button_add_new');?></a>
				<a href="<?=admin_url('compogen');?>" class="button btn-sm btn-default"><i class="icon-cup2 mr-2"></i>CompoGen</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<table id="DataTable" class="display responsive no-wrap table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th><?=lang_line('table_type');?>
							<th><?=lang_line('table_status');?></th>
							<th class="no-sort text-center"><?=lang_line('table_action');?></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
