	...
	<div class="block">
		<div class="block-header">
			...
			<div class="pull-right">
				<button class="modal_add button btn-primary btn-sm"><i class="icon-add"></i> <?=lang_line('button_add_new');?></button>
			</div>
		</div>
		<div class="row">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5 class="modal-title"><i class="fa fa-tags mr-2"></i><?=lang_line('dialog_add_title');?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			</div>
			<div class="modal-body">
				<div>
					<input id="tag" type="text" name="tags" class="input-tags" required>
					<small><i><?=lang_line('mod_lang_1'); ?></i></small>
				</div>
			</div>
