...
<div class="page-header page-header-light">
	...
	<div class="breadcrumb-line breadcrumb-line-light">
		<div class="breadcrumb">
			...
			<span class="breadcrumb-item"><?=lang_line('mod_title_role');?></span>
		</div>
	</div>
</div>
...
<div class="content">
	...
	<div class="block">
		<div class="block-header">
			<h3><?=lang_line('mod_title_role');?></h3>
			<div class="pull-right">
				<button type="button" class="add_module_role button btn-sm btn-primary"><i class="icon-add mr-1"></i><?=lang_line('button_add_role');?></button>
				<a href="<?=admin_url($this->mod.'/level');?>" class="button btn-sm btn-default ml-2"><i class="icon-medal2  mr-1"></i><?=lang_line('button_level_user');?></a>
			</div>
		</div>

		<div class="row">
			<div class="col-md-12">
				<h4>Level : <span class="text-strong text-primary"><?=$res_level['title'];?></span></h4>
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover table-vcenter no-footer">
						<thead>
							<tr>
								<th class="text-center"><?=lang_line('mod_lang_2');?></th>
								<th class="text-center"><?=lang_line('table_access_read');?></th>
								<th class="text-center"><?=lang_line('table_access_write');?></th>
								<th class="text-center"><?=lang_line('table_access_modify');?></th>
								<th class="text-center"><?=lang_line('table_access_delete');?></th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<div class="btn-group">
										<button class="button btn-xs btn-default edit_module_role" data-toggle="tooltip" data-placement="top" data-title="<?=lang_line('button_edit');?>" id-module="<?=$res_mod['role_id'];?>"><i class="fa fa-pencil"></i></button>
										<button class="moda_delete_module button btn-xs btn-default" data-toggle="tooltip" data-placement="top" data-title="<?=lang_line('button_delete');?>" idMod="<?=$res_mod['role_id'];?>" ><i class="icon-bin"></i></button>
									</div>
								</td>
							</tr>
							<?php endforeach ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5><i class="icon-clipboard2 mr-2"></i><?=lang_line('mod_add_role');?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
				<div class="form-group">
					<label><?=lang_line('mod_lang_2');?> <span class="text-danger">*</span></label>
					<select name="module" class="select-2" data-placeholder="<?=lang_line('mod_lang_3');?>" required>
						<option value=""></option>
						<?php
				...
				<label><?=lang_line('mod_lang_1');?></label>
				<div>
...
<div id="modal_edit_module_role" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5><i class="icon-clipboard2 mr-2"></i><?=lang_line('mod_edit_role');?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="submit" class="button btn-md btn-primary"><i class="fa fa-save mr-2"></i><?=lang_line('button_save');?></button>
				<button type="button" class="button btn-md btn-default" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times mr-2"></i><?=lang_line('button_cancel');?></button>
			</div>
			<?=form_close();?>
		</div>
	</div>
...
<div id="modal_delete_module" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4><i class="fa fa-exclamation-triangle text-danger mr-3"></i><?=lang_line('dialog_delete_title');?></h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-md btn-danger"><i class="icon-bin mr-2"></i><?=lang_line('button_yes');?></button>
				<button type="button" class="btn btn-md btn-default" data-dismiss="modal" aria-hidden="true"><i class="fa fa-sign-out mr-2"></i><?=lang_line('button_no');?></button>
			</div>
			<?=form_close();?>
		</div>
	</div>
