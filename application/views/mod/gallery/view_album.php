...
<div class="page-header page-header-light">
	...
	<div class="breadcrumb-line breadcrumb-line-light">
		<div class="breadcrumb">
			...
			<span class="breadcrumb-item"><?=lang_line('mod_title_album');?></span>
		</div>
	</div>
</div>
...
<div class="content">
	...
	<div class="block">
		<div class="block-header">
			<h2><?=lang_line('mod_title_album');?> : <small><?=$res_album['title'];?></small></h2>
			<div class="pull-right">
				<button type="button" idAlbum="<?=$res_album['id'];?>" class="modal_add_picture button btn-sm btn-primary mr-2"><i class="fa fa-image"></i>&nbsp; <?=lang_line('button_add_picture'); ?></button>
		...
		<div class="col-md-12">
			<div class="row">
				...
				?>
				<div id="gallery-item<?=$res['id'];?>" class="col-lg-2">
					<div class="card item-gal">
						<div class="galdel delete_gallery_image" data-id="<?=encrypt($res['id']);?>"><i class="fa fa-times"></i></div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5><i class="fa fa-image mr-2"></i><?=lang_line('dialog_title_add_picture'); ?></h5>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<label><?=lang_line('form_label_picture'); ?></label>
							<div class="input-group">
								<div class="input-group-prepend">
									<button type="button" id="browse-files" href="<?=content_url('plugins/filemanager/dialog.php?type=1&relative_url=1&field_id=pictures&sort_by=date&descending=1&akey='.login_key('admin'));?>" class="btn btn-default">
			...
			<div class="modal-footer">
				<button type="submit" class="button btn-md btn-primary pull-left"><i class="fa fa-check mr-2"></i><?=lang_line('button_submit'); ?></button>
				<button type="reset" class="button btn-md btn-default delpict" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times mr-2"></i><?=lang_line('button_cancel'); ?></button>
			</div>
			<?=form_close();?>
		</div>
	</div>
