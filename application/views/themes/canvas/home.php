					...
					<div class="fslider bnews-slider nobottommargin" data-speed="800" data-pause="6000" data-arrows="false" data-pagi="false">
						<div class="flexslider">
							<div class="slider-wrap">
								...
								?>
								<div class="slide">
									<a href="<?=post_url($row_hnews['seotitle']);?>" title="<?=$row_hnews['title'];?>"><small class="text-muted"><?=ci_date($row_hnews['datepost'].$row_hnews['timepost'],'l, H:i A');?></small> - <strong><?=$row_hnews['title'];?></strong></a>
								</div>
								<?php endforeach ?>
							</div>
						</div>
								...
								<div class="slider-wrap">
									...
									<div class="slide" data-thumb="">
										<a href="<?=post_url($res_headline['post_seotitle']);?>" title="<?=$res_headline['post_title'];?>">
											<img src="<?=post_images($res_headline['picture'],'',true);?>" alt="<?=$res_headline['post_title'];?>">
											<div class="overlay">
												<div class="text-overlay">
													<div class="text-overlay-title">
														<h3><?=$res_headline['post_title'];?></h3>
													</div>
						...
						<div class="ipost clearfix">
							...
							<div class="col_half bottommargin-sm">
								...
								<ul class="entry-meta clearfix">
									<li><i class="icon-calendar3"></i> <?=ci_date($res_post1a['datepost'].$res_post1a['timepost'], 'l, d F Y');?></li>
									<li><i class="icon-folder-open"></i> <a href="<?=site_url('category/'.$res_post1a['category_seotitle']);?>"><?=$res_post1a['category_title'];?></a></li>
								</ul>
							...
							<div class="col_half nobottommargin col_last">
								...
								<div class="spost clearfix">
									...
									<div class="entry-c">
										...
										<ul class="entry-meta clearfix">
											<li><i class="icon-calendar3"></i> <?=ci_date($res_post1b['datepost'].$res_post1b['timepost'], 'l, d F Y');?></li>
											<li><i class="icon-folder-open"></i> <a href="<?=site_url('category/'.$res_post1b['category_seotitle']);?>"><?=$res_post1b['category_title'];?></a></li>
										</ul>
									</div>
								</div>
								<?php endforeach ?>
							...
							<div class="col_half nobottommargin">
								<div class="entry-image">
									<a href="<?=post_url($res_post2a['post_seotitle'])?>" title="<?=$res_post2a['post_title'];?>">
										<img src="<?=post_images($res_post2a['picture'], 'medium', TRUE);?>" alt="<?=$res_post2a['post_title'];?>" class="image_fade">
									</a>	
								</div>
							</div>
							<div class="col_half nobottommargin col_last">
								...
								<ul class="entry-meta clearfix">
									<li><i class="icon-calendar3"></i> <?=ci_date($res_post2a['datepost'].$res_post2a['timepost'], 'l, d F Y');?></li>
									<li><i class="icon-folder-open"></i> <a href="<?=site_url('category/'.$res_post2a['category_seotitle']);?>"><?=$res_post2a['category_title'];?></a></li>
								</ul>
								<div class="entry-content">
									<p><?=cut($res_post2a['content'], 250);?>...</p>
								</div>
							</div>
						</div>
						<?php endforeach ?>
							...
							<div class="spost clearfix">
								<div class="entry-image">
									<a href="<?=post_url($res_post2b['post_seotitle']);?>" title="<?=$res_post2b['post_title'];?>">
										<img alt="<?=$res_post2b['post_title'];?>" src="<?=post_images($res_post2b['picture'], 'thumb', TRUE);?>">
									</a>
								</div>
								<div class="entry-c">
									<div class="entry-title">
										<h4><a href="<?=post_url($res_post2b['post_seotitle']);?>" title="<?=$res_post2b['post_title'];?>"><?=$res_post2b['post_title'];?></a></h4>
									</div>
									<ul class="entry-meta clearfix">
										<li><i class="icon-calendar3"></i> <?=ci_date($res_post2b['datepost'].$res_post2b['timepost'], 'l, d F Y');?></li>
										<li><i class="icon-folder-open"></i> <a href="<?=site_url('category/'.$res_post2b['category_seotitle']);?>"><?=$res_post2b['category_title'];?></a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="<?=post_url($res_post3a['post_seotitle'])?>" title="<?=$res_post3a['post_title'];?>">
										<img src="<?=post_images($res_post3a['picture'], 'medium', TRUE);?>" alt="<?=$res_post3a['post_title'];?>" class="image_fade">
									</a>
								</div>
								<div class="entry-title">
									<h3>
								...
								<ul class="entry-meta clearfix">
									<li><i class="icon-calendar3"></i> <?=ci_date($res_post3a['datepost'].$res_post3a['timepost'], 'l, d F Y');?></li>
									<li><i class="icon-folder-open"></i> <a href="<?=site_url('category/'.$res_post3a['category_seotitle']);?>"><?=$res_post3a['category_title'];?></a></li>
								</ul>
								<div class="entry-content">
									<p><?=cut($res_post3a['content'], 100);?>...</p>
								</div>
							</div>
						</div>
						<?php endforeach ?>
