...
<section id="page-title">
	<div class="container clearfix">
		<h1><?php echo $result_category['title']?></h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?php echo site_url();?>">Home</a></li>
			<li class="breadcrumb-item"><a href="<?php echo site_url('index');?>">Category</a></li>
			<li class="breadcrumb-item active" aria-current="page"><?php echo $result_category['title']?></li>
		</ol>
	</div>
</section>
<section id="content">
						...
						<div class="entry clearfix">
							...
							<div class="entry-c">
								...
								<ul class="entry-meta clearfix">
									...
									<li><i class="icon-eye"></i> <?php echo $res['hits'];?></li>
								</ul>
								<div class="entry-content">
									<p><?php echo cut($res['content'],150);?>...</p>
									<a href="<?php echo post_url($res['post_seotitle']);?>" class="more-link">Read More</a>
								</div>
							</div>
						</div>
						<?php endforeach ?>
