<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
				...
				<div class="footer-widgets-wrap clearfix">
					<div class="col_two_third">
						<div class="col_one_third">
							<div class="widget clearfix">
								<img src="<?=$this->CI->theme_asset();?>/images/footer-widget-logo.png" alt="logo" class="footer-logo">
								<div style="background: url('<?=$this->CI->theme_asset();?>/images/world-map.png') no-repeat center center; background-size: 100%;">
									<address>
									...
									<?php
										...
										foreach ($footer_category as $rescount):
											...
											if ( is_null($row_scategory['id']) || $num_spost < 1 )
												continue;
									?>
									<li><a href="<?=site_url('category/'.$row_scategory['seotitle']);?>"><?=$row_scategory['title'];?></a></li>
									<?php endforeach ?>
								</ul>
							</div>
						</div>
									...
									<div class="spost clearfix">
										<div class="entry-c">
											<div class="entry-title">
												<h4>
													<a href="<?=post_url($row['seotitle'])?>" title="<?=$row['title'];?>"><?=cut($row['title'],50)?>...</a>
												</h4>
											</div>
											<ul class="entry-meta">
												<li><?=ci_date($row['datepost'],'l, d F Y');?></li>
											</ul>
										</div>
									</div>
									<?php endforeach ?>
					...
					<div class="col_one_third col_last">
						...
						<div class="widget subscribe-widget clearfix">
							<h5><strong>Berlangganan</strong> :</h5>
			...
			<div id="copyrights">
				<div class="container clearfix">
					<div class="col_half pt-1">
						Copyright <?=date('Y')?> <?=$this->settings->website('web_name')?> <a href="https://opensource.org/licenses/MIT" target="_blank">MIT License</a>. Theme Canvas By <a href="https://themeforest.net/user/semicolonweb/portfolio?ref=SemiColonWeb" target="_blank">SemiColonWeb</a>.
					</div>
	...
	<!-- JavaScripts -->
	<script src="<?=$this->CI->theme_asset('js/jquery.js');?>"></script>
	<script src="<?=$this->CI->theme_asset('js/plugins.js');?>"></script>
	<script src="<?=$this->CI->theme_asset('js/functions.js');?>"></script>
	<script>
