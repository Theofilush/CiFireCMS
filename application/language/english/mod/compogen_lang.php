...
<li><p>Component modules generated from CompoGen are components for ordinary data CRUD (Create Read Update Delete) processes. For further additional features, we submit it to the developer.</p></li>
<li><p>CompoGen will automatically create a new component module file and create a new table in the database. You may study the CompoGen documentation carefully.</p></li>';